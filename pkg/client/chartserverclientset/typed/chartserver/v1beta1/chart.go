...
type ChartInterface interface {
	...
	UpdateStatus(*v1beta1.Chart) (*v1beta1.Chart, error)
...
func newCharts(c *ChartserverV1beta1Client, namespace string) *charts {
	return &charts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *charts) UpdateStatus(chart *v1beta1.Chart) (result *v1beta1.Chart, err error) {
	result = &v1beta1.Chart{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("charts").
