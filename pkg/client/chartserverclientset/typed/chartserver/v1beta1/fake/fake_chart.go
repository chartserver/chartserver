...
var chartsResource = schema.GroupVersionResource{Group: "chartserver.io", Version: "v1beta1", Resource: "charts"}

var chartsKind = schema.GroupVersionKind{Group: "chartserver.io", Version: "v1beta1", Kind: "Chart"}
...
func (c *FakeCharts) UpdateStatus(chart *v1beta1.Chart) (*v1beta1.Chart, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(chartsResource, "status", c.ns, chart), &v1beta1.Chart{})
