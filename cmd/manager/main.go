...
func main() {
	...
	flag.StringVar(&serverAddr, "server-addr", ":8000", "the address the webserver binds to.")
	...
	if err := controller.StartWebServer(cfg, serverAddr); err != nil {
		log.Error(err, "unable to start web server")
		os.Exit(1)
	}
